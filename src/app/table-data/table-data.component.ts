...
export class TableDataComponent {
  ...
  out(idStat: number) {
    let tt =
      parseInt(this.update.outtime.split(':')[0]) -
      parseInt(this.update.intime.split(':')[0]) +
      (parseInt(this.update.outtime.split(':')[1]) -
        parseInt(this.update.intime.split(':')[1])) /
        60;
    console.log(tt);
